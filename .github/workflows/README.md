...
Final-year engineering student building toward SRE / Platform Engineering.

- 🔭 Currently building: **Policy-as-Code Enforcement & Observability Platform** on GCP
...
`Python` `Go` `Terraform` `Docker` `Kubernetes` `GCP` `GitHub Actions` `Bash`
